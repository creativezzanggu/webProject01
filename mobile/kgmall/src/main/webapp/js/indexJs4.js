            ...
            try {
                ...
                if (iCurrentHeightPos > iButtonHeightPos || iButtonHeightPos < $(this).scrollTop() + $item.height()) {
                    if (iButtonHeightPos < $(this).scrollTop() - $item.height()) {
                        $area.fadeIn('fast');
						$("#wrap").css("padding-bottom",$("#orderFixArea").height()+"px");
...
/****************************************************************************************************
	...
	[작성예]
	MON-FRI AM10:00 - PM5:00 <br> LUNCH PM12:00 - PM1:00 <br> SAT.HOLIDAY OFF

****************************************************************************************************/

//고객센터 운영시간을 입력해주세요.
DF['rep-cstime-txt'] = "MON-FRI AM10:00 - PM5:00 <br> LUNCH PM1:00 - PM2:00 <br> SAT.SUN.HOLIDAY OFF";
...
//첫번째줄 표시문구
DF['rep-returnex-txt1'] = "480842 경기도 의정부시 의정부1동 126-9번지 1층";
...
/****************************************************************************************************
	...
	- 사이트하단에 표시되는 계좌정보를 아래의 소스에서 수정해주세요.
	- 아래항목 뒷부분의 쌍따옴표("") 안에 표시될 계좌번호 및 예금주명을 입력하시면 됩니다.
	- 계좌번호의 개수를 추가할 경우 DF['ins-banking-li'][다음숫자] = ""; 라인 한줄을 아래로 추가하세요.
	- 아래 한줄을 추가할경우 항목중 [숫자] 부분을 다음숫자로 입력해주세요.

****************************************************************************************************/

//입금계좌번호(사용하시는 계좌번호 및 예금주로 변경해주세요)
DF['ins-banking-li'][1] = "KB 664601-01-298933";
DF['ins-banking-li'][2] = "SHINHAN 100-031-661722";
DF['ins-banking-li'][3] = "IBK 008-119025-01-011";
DF['ins-banking-li'][4] = "예금주: 배태상";
...
/****************************************************************************************************
	...
	- 사이트를 스크롤시 상단에 로고·메뉴·분류중 하나의 대상을 고정할 수 있습니다.
	- 아래 객체대상 설정값중 하나를 입력해주세요.

	[객체대상 설정값]
	로고영역 고정값: logo
	메뉴영역 고정값: menu
	분류영역 고정값: cate
	값을 입력하지 않은경우: 아무것도 고정되지 않음

****************************************************************************************************/

//상단고정(픽스) 객체설정
DF['set-fixchooes'] = "logo";
...
/****************************************************************************************************
	...
	- 아래 설정에 따라 메인화면에 보여지는 배너를 자유롭게 배치할 수 있습니다.
	- 배너는 한줄에 설정된 값보다 더 많이 등록할 경우 다음줄에 보여집니다.
	- 1,2,3으로 입력할 경우 첫줄은 1개, 둘째줄은2개, 셋째줄은 3개로 표시됩니다.
	- 1,2,3으로 입력되고, 배너를 더 많이 등록할 경우 그다음줄부터 3개로 계속 표시됩니다.

	[배너 표시여부 설정]
	- 표시여부는 C스토어 배너관리v2앱에서 사용여부를 설정해주세요
...
/****************************************************************************************************
	...
	※ 디자인관련-상품분류메뉴 가로개수 설정 ※

	- 상품분류메뉴의 가로개수를 설정하실 수 있습니다.
	- 세로개수의 경우 표시되는 분류의 개수가 가로칸수보다 많을경우 자동으로 늘어납니다.
	- 입력값: 1~5의 사이의 값을 입력해주세요.
...
/****************************************************************************************************
	...
	※ 디자인관련-상품목록 이미지 가로개수 설정 ※

	- 진열된 상품목록의 가로개수를 설정할 수 있습니다.

****************************************************************************************************/

//메인상품목록 1-4단 보기버튼 표시여부
DF['use-mlisttype'] = "on";

//일반상품목록 1-4단 보기버튼 표시여부
DF['use-slisttype'] = "on";

//메인상품목록 가로개수 설정 (1~4 값입력)
DF['set-mlistcols'] = "2";

//일반상품목록 가로개수 설정 (1~4 값입력)
DF['set-slistcols'] = "2";
...
//상세페이지 하단 가이드
//C스토어 > 배너관리v2 > 모바일쇼핑몰 > 상세페이지하단가이드 우측의 [사용여부버튼]으로 설정하세요.
...
//사용하시는 네이버톡톡 링크로 변경해주세요.
DF['put-navertalk-href'] = "http://talk.naver.com/WCBXXN";
...
//사용하시는 옐로아이디 링크로 변경해주세요.
DF['put-yellowid-href'] = "http://plus.kakao.com/home/@디자인플로어";
...
DF['use-facebook'] = "on";
//페이스북 주소
DF['put-facebook-href'] = "http://facebook.com/";


//트위터 아이콘 표시여부
DF['use-twitter'] = "off";
//트위터 주소
DF['put-twitter-href'] = "http://twitter.com/";


//인스타그램 아이콘 표시여부
DF['use-instagram'] = "on";
//인스타그램 주소
DF['put-instagram-href'] = "http://instagram.com/";


//블로그 아이콘 표시여부
DF['use-blog'] = "on";
//블로그 주소
DF['put-blog-href'] = "http://blog.naver.com/";


//카페 아이콘 표시여부
DF['use-cafe'] = "off";
//카페 주소
DF['put-cafe-href'] = "http://blog.naver.com/";


//카카오스토리·채널 아이콘 표시여부
DF['use-kakao'] = "off";
//카카오스토리 주소
DF['put-kakao-href'] = "http://story.kakao.com/";


//옐로아이디 아이콘 표시여부
DF['use-yid'] = "off";
//옐로아이디 주소
DF['put-yid-href'] = "http://plus.kakao.com/home/@디자인플로어";


//네이버톡톡 아이콘 표시여부
DF['use-ntalk'] = "off";
//네이버톡톡 주소
DF['put-ntalk-href'] = "http://talk.naver.com/WCBXXN";


//웨이보 아이콘 표시여부
DF['use-weibo'] = "off";
//웨이보 주소
DF['put-weibo-href'] = "http://weibo.com/";


//QQ 아이콘 표시여부
DF['use-qq'] = "off";
//QQ 주소
DF['put-qq-href'] = "http://weibo.com/";


//핀터레스트 아이콘 표시여부
DF['use-pinterest'] = "off";
//핀터레스트 주소
DF['put-pinterest-href'] = "http://pinterest.com/";


//텀블러 아이콘 표시여부
DF['use-tumblr'] = "off";
//텀블러 주소
DF['put-tumblr-href'] = "http://www.tumblr.com/";


//유투브 아이콘 표시여부
DF['use-youtube'] = "off";
//유투브 주소
DF['put-youtube-href'] = "http://youtube.com/";
/*
  디자인플로어 라이센스 안내
  대표전화: 1544-4941
  홈페이지: http://www.dfloor.co.kr
  특허청출원번호: 4120150030498
  본 스크립트의 저작권은 디자인플로어 귀속되어 있습니다. 무단 복제 및 배포,침해,도용,부분사용,부분변경을
  금지하며 위반시 저작권 관련법에 따라 법률적 조치가 이루어 질 수 있습니다.
*/

!function(b){b.getQuery=function(a,b){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var c="[\\?&]"+a+"=([^&#]*)",d=new RegExp(c);if(b)var e=d.exec(b);else var e=d.exec(window.location.href);return null!==e&&e[1]};var d=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver;b.fn.attrchange=function(a){if(d){var b={subtree:!1,attributes:!0},c=new d(function(b){b.forEach(function(b){a.call(b.target,b.attributeName)})});return this.each(function(){c.observe(this,b)})}},b(document).ready(function(){function h(){b(document).scrollTop()<=1?b("#topBtn").fadeOut("fast"):b("#topBtn").fadeIn("fast")}function k(){b(".xans-photoslide2 .sliderPaging.sliderPaging1 .swiper-pagination-switch span").remove(),b(".xans-photoslide2 .sliderPaging.sliderPaging1 .swiper-pagination-switch").append("<span></span>"),b(".xans-photoslide2 .sliderPaging.sliderPaging1 .swiper-pagination-switch span").css({display:"inline-block",float:"left",width:"0px",height:"3px",background:"#bbb"}),b(".xans-photoslide2 .sliderPaging.sliderPaging1 .swiper-pagination-switch.selected span").animate({width:"16px"},3400,"linear",function(){})}b("a").click(function(a){"#none"==b(this).attr("href")&&a.preventDefault()}),b("#globalShopArea .xans-multishop.xans-multishop-listitem.globalThumb > ul > li").each(function(a){""!=b.trim(b(this).attr("class"))&&b("#globalShopArea").css("display","block")});var e={init:function(){b("#container").append('<a href="#none" id="gn-sideSlide-dimmed"></a>'),e.resize(),b(window).resize(function(){e.resize()})},action:function(a){b("html, body").toggleClass("no-scroll"),b("html").toggleClass("gn-sideSlide-"+a.slideDirection),b("#gn-sideSlide-dimmed").toggleClass(a.slideDirection),b("html").hasClass("gn-sideSlide-"+a.slideDirection)?b("#gn-sideSlide-"+a.slideDirection).show():(b("#wrap").addClass("gn-sideSlide"),setTimeout(function(){b("#gn-sideSlide-"+a.slideDirection).hide(),b("#wrap").removeClass("gn-sideSlide")},500))},resize:function(){var a=b("body").height();b("#container").css({"min-height":a})}};e.init(),b("#gn-sideSlide-dimmed").click(function(a){a.preventDefault(),1!=b(".ani-menuBtn").hasClass("ani")&&1!=b(".ani-searchBtn").hasClass("ani")||(b(".ani-menuBtn").removeClass("ani"),b(".ani-searchBtn").removeClass("ani"),e.action({slideDirection:b("#gn-sideSlide-dimmed").attr("class")}))}),b(".ani-menuBtn").click(function(a){b(this).toggleClass("ani"),e.action({slideDirection:"left"})}),b(".ani-searchBtn").click(function(a){b(this).toggleClass("ani"),e.action({slideDirection:"right"})});var f,g;b("#topBanner li").each(function(){1!=b.cookie("bannerTop_"+b(this).find("a.banner img").attr("rel"))&&b(this).css("display","block")}),b("#topBanner li .bannerClose").click(function(a){var c=b(this).parent("li"),d=b(this).next("a").find("img").attr("rel");c.slideUp("fast",function(){b(this).css("display","none");var a=new Date;a.setTime(a.getTime()+12e5),b.cookie("bannerTop_"+d,1,{expires:a,path:"/",secure:!1}),void 0!==DF["set-fixchooes"]&&(g=b('#header [data-id="'+DF["set-fixchooes"]+'"]').parent().offset().top+parseInt(b('#header [data-id="'+DF["set-fixchooes"]+'"]').parent().css("padding-top").replace(/[^-\d\.]/g,"")))})}),void 0!==DF["set-fixchooes"]&&b("#header [data-fixed-id]").each(function(){DF["set-fixchooes"]==b(this).attr("data-id")&&(f=b(this),g=f.parent().offset().top+parseInt(f.parent().css("padding-top").replace(/[^-\d\.]/g,"")),b(document).scrollTop()>=g&&!b(document).scrollTop()<=0?f.addClass(f.attr("data-fixed-id")):f.removeClass(f.attr("data-fixed-id")),b(document).bind("scroll touchstart touchend touchmove touchcancel",function(a){g=f.parent().offset().top+parseInt(f.parent().css("padding-top").replace(/[^-\d\.]/g,"")),b(document).scrollTop()>=g&&!b(document).scrollTop()<=0?0==b("html").hasClass("no-scroll")&&f.addClass(f.attr("data-fixed-id")):(f.removeClass(f.attr("data-fixed-id")),f.parent().css("height",parseInt(f.height())))}),b(window).resize(function(){g=f.parent().offset().top+parseInt(f.parent().css("padding-top").replace(/[^-\d\.]/g,"")),f.parent().css("height",parseInt(f.height()))}))}),b("aside .tab li").click(function(a){b(this).addClass("selected").siblings().removeClass("selected"),b("#"+b(this).children().attr("data-tab-id")).show().siblings(".displayTab").hide()}),b(".xans-popup-mobile img.ThumbImage")&&b(".xans-popup-mobile img.ThumbImage").attr("style",""),b(".mPrdList h2").click(function(a){b(this).toggleClass("ani")}),b(document).scroll(function(){setTimeout(h,70)}),b("#topBtn").hover(function(){b(this).css("background-color","rgba(85,85,85,0.65)")},function(){b(this).css("background-color","rgba(85,85,85,0.65)"),h()}),b("#topBtn").click(function(a){return b("html, body").animate({scrollTop:0},200,"easeout"),!1}),b(".mBanner").each(function(){var c=1.5,d=1.5,e=DF["set-bannercols"].split(","),f=DF["set-bannercols"].split(","),g=0,h=-1,i=0;if(b.each(e,function(a){i+=parseInt(e[a])}),i<b(this).find("li").length)for(var j=0;j<Math.ceil((b(this).find("li").length-i)/e[e.length-1]);j++)e.push(e[e.length-1]),f.push(f[f.length-1]);b.each(f,function(a){f[a]=parseInt(f[a]),e[a]=parseInt(e[a]),e.length>a+1&&(f[a+1]=parseInt(f[a])+parseInt(f[a+1]))}),b(this).find("li").each(function(i){b.each(f,function(a){if(f[a]>i)return g=a,!1}),i<f[f.length-2]?g!=h?b(this).css({width:Math.floor((100-d*(e[g]-1))/e[g]*1e3)/1e3+"%","margin-top":c+"%"}):b(this).css({width:Math.floor((100-d*(e[g]-1))/e[g]*1e3)/1e3+"%","margin-left":d+"%","margin-top":c+"%"}):(a=f[f.length-1]-b(".mBanner").find("li").length,g!=h?b(this).css({width:Math.floor((100-d*(e[g]-a-1))/(e[g]-a)*1e3)/1e3+"%","margin-top":c+"%"}):b(this).css({width:Math.floor((100-d*(e[g]-a-1))/(e[g]-a)*1e3)/1e3+"%","margin-left":d+"%","margin-top":c+"%"})),h=g})});var i=function(a,c){a.addClass("on").siblings().removeClass("on"),sortNum=a.attr("data-sort"),b(".mPrdList").each(function(){void 0!==b(this).attr("id")&&b(this).attr("id").indexOf("slider")>0?b(this).find("> ul > li > ul").removeClass("grid1 grid2 grid3 grid4").addClass("grid"+sortNum):b(this).find("> ul").removeClass("grid1 grid2 grid3 grid4").addClass("grid"+sortNum)})};b(".mPrdListSort a").click(function(a){i(b(this))}),b(".mPrdListSort a").each(function(a){if(a+1==DF["set-mlistcols"])return i(b(this)),!1});var j=function(a,c){a.addClass("on").siblings().removeClass("on"),sortNum=a.attr("data-sort"),b(".xans-product-listnormal").each(function(){b(this).find("> ul").removeClass("grid1 grid2 grid3 grid4").addClass("grid"+sortNum)})};b(".sPrdListSort a").click(function(a){j(b(this))}),b(".sPrdListSort a").each(function(a){if(a+1==DF["set-slistcols"])return j(b(this)),!1}),b(".xans-product-normalmenu .xans-product-orderby").find("a").each(function(){b.getQuery("sort_method",b(this).attr("href"))==b.getQuery("sort_method")&&b(this).addClass("on")}),b(".xans-photoslide2 .sliderPaging.sliderPaging1 .swiper-pagination-switch").attrchange(function(){k()}),k(),b("#categoryMenu").each(function(){b(this).find("ul").removeClass("mtl0-cols1 mtl0-cols2 mtl0-cols3 mtl0-cols4 mtl0-cols5 mtl0-cols6 mtl0-cols7 mtl0-cols8 mtl0-cols9 mtl0-cols10").addClass("mtl0-cols"+parseInt(DF["set-catecols"]))}),function(){b.each(DF,function(d,e){if(a=d.split("-"),s=d.split("-"),s.splice(s.length-1,1),id=s.join("-"),"use"==a[0])b("#"+d+", ."+d).length>0&&("on"==e?b("#"+d+", ."+d).show():"off"==e&&b("#"+d+", ."+d).hide());else if("put"==a[0])b("#"+id+", ."+id).length>0&&b("#"+id+", ."+id).attr(a[a.length-1],e);else if("rep"==a[0])b("#"+id+", ."+id).length>0&&(b("#"+id+", ."+id).length>1?b("#"+id+", ."+id).each(function(){b(this).parent().html().indexOf("\x3c!--{"+d+"}--\x3e")>=0?b(this).parent().html(b(this).parent().html().replace("\x3c!--{"+d+"}--\x3e",e)):b(this).parent().html().indexOf("{"+d+"}")>=0&&b(this).parent().html(b(this).parent().html().replace("{"+d+"}",e))}):b("#"+id+", ."+id).parent().html().indexOf("\x3c!--{"+d+"}--\x3e")>=0?b("#"+id+", ."+id).parent().html(b("#"+id+", ."+id).parent().html().replace("\x3c!--{"+d+"}--\x3e",e)):b("#"+id+", ."+id).parent().html().indexOf("{"+d+"}")>=0&&b("#"+id+", ."+id).parent().html(b("#"+id+", ."+id).parent().html().replace("{"+d+"}",e)));else{if("ins"!=a[0])return!0;b("#"+id+", ."+id).length>0&&(c=0,b.each(DF[d],function(d,e){e.length>0&&(b("#"+id+", ."+id).append("<"+a[a.length-1]+' class="'+id+"-"+(c+1)+'">'+e+"</"+a[a.length-1]+">"),c++)}))}})}(),b.each("#prdDetailContent #boardContent".split(" "),function(a,c){var d=b(c);d.length>0&&b.each("width height hspace vspace".split(" "),function(a,b){d.find("img").removeAttr(b),d.find("img").css(b,"")})})})}($DF);
...
(function($){
	$(document).ready(function(){
		...
		// 메인 상품분류별 배너 각자 위치로 보내기 2017-04-19
		$(this).find(".df-categorybanner").each(function(){var a=$(".xans-product-listmain");if(a.length<=0)return!1;var b=$(this).detach();if(b.find(".banner_image").length<=0)return!1;var e,c=b.find("li"),d=c.length;b.find("li").remove(),c.each(function(c){var f=$(this),g=b[0].outerHTML;a.eq(c).length>0?(a.eq(c).after($(g).append(f[0].outerHTML)[0].outerHTML),e=$(".df-categorybanner").last()):(e.after($(g).append(f[0].outerHTML)[0].outerHTML),e=$(".df-categorybanner").last()),0==c?e.addClass("first-child"):d==c+1&&e.addClass("last-child"),e.addClass("nth-child-"+(c+1))})});

		// 배너 이미지 Attr 제거(width·height·hspace·vspace·title 값 제거) 2017-04-19
...
$(document).ready(function(){
        ...
        show: function(overNode, iCateNo) {
            ...
            if (methods.aSubCategory[iCateNo] != undefined) {
                ...
                $(methods.aSubCategory[iCateNo]).each(function() {
					...
					aHtml.push('<a href="/product/list.html'+this.param+'" class="cate">'+this.name+'</a>');
                    //if (methods.aSubCategory[sNextParentNo] != undefined)  aHtml.push('<a href="/product/list.html'+this.param+'" class="view">상품보기</a>');
					if (methods.aSubCategory[sNextParentNo] != undefined)  aHtml.push('<a href="#none" class="onoff" cate="'+this.param+'" onclick="subMenuEvent(this);"></a>');
    ...
    $('#slideCateList li > a.onoff').click(function(e) {
        var iCateNo = Number(methods.getParam($(this).attr('cate'), 'cate_no'));
    ...
    $('#gn-sideSlide-left ul a.onoff').click(function(e){
