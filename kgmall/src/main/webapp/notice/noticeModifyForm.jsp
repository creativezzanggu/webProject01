...
<form name="noticeModifyForm" method="post" action="/kgmall/notice/noticeModify.do">
	...
	<tbody>
		<tr class="first">
			...
			<td>
				...
				<input id="subject" name="subject" value="${subject }" fw-filter="isFill" fw-label="제목" fw-msg="" class="inputTypeText" placeholder="" maxlength="125" value="" type="text">
				<input id="notice0"  fw-filter="" fw-label="공지사항" fw-msg="" value="T" type="checkbox">
				<label for="notice0">공지사항</label>
				<input id="is_post0"  fw-filter="" fw-label="게시안함" fw-msg="" value="B" type="checkbox">
...
<div class="btnArea btnAreaCustom ">
	...
	<input type="submit" value="수정" id="modifyBtn" class="btn Normal Dark Wnormal mL5">
