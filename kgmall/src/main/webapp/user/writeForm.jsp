...
<div class="ec-base-box typeThinBg gStrong">
   <p><input type="checkbox" id="allcheck"><em class="checkbox"></em></span><label for="allcheck"><strong>이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong></label></p>
</div>
<div class="ec-base-box typeThinBg agreeArea df-agreeArea">
<div class="left">
<h3>[필수] 이용약관 동의</h3>
	<div class="content">
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.	
		...
		<p class="check"><span>이용약관에 동의하십니까?</span> <input id="check1" name="check1" value="1" type="checkbox"  /><label for="agree_service_check0" >동의함</label></p>
</div>
...
<h3>[필수] 개인정보 수집 및 이용 동의</h3>
	...
	<p class="check"><span>개인정보 수집 및 이용에 동의하십니까?</span> <input id="check2" name="check2" value="1" type="checkbox"  /><label for="agree_privacy_check0" >동의함</label></p>
	</div>
</div>
