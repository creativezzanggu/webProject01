...
{
    // 팝업창 링크
    var sLink = sLink ? sLink : 'http://ecudemo31431.cafe24.com/product/image_zoom.html';
...
{
    // 팝업창 링크
    var sLink = sLink ? sLink : 'http://ecudemo31431.cafe24.com/product/image_zoom2.html';
    sLink += '?product_no=' + iProductNo + '&cate_no=' + iCategoryNo + '&display_group=' + iDisplayGroup;
    // 팝업창 옵션
    var sOptions = sOption ? sOption : 'toolbar=no,scrollbars=no,resizable=yes,width=800,height=640,left=0,top=0';
    // 팝업창 이름
...
var EC_ListAction = {
    ...
    setBasketPrepare : function(sType)
    {
        ...
        var sAction = 'http://ecudemo31431.cafe24.com/exec/front/order/basket/';
    ...
    selectbuy_action :function(iProductNo)
    {
        ...
        var sUrl = 'http://ecudemo31431.cafe24.com/exec/front/order/basket/?command=select_prdcnt&product_no=' + iProductNo + '&option_type=T&' + aOptionId.join("&");
        $.ajax({
            url : sUrl,
            dataType : 'json',
            async : false,
...
//                if (this.setSelectedItemHasOptionT() === false || this.setSelectedItemHasOptionF() === false || this.setSingleSelectedItem() === false) {
    ...
    VALIDATION : {
        ...
        isRequireLogin : function()
        {
            ...
            btn_action_move_url('http://ecudemo31431.cafe24.com/member/login.html');
            return false;
        },
...
function set_sms_restock(iProductNo) {
    ...
    window.open('http://ecudemo31431.cafe24.com/product/sms_restock.html?product_no=' + iProductNo, 'sms_restock', 200, 100, 459, 490);
}
...
function selectbuy_action(sOptionParam, iProductNo, sSelectedItemByEtype)
{
    ...
    var sUrl = 'http://ecudemo31431.cafe24.com/exec/front/order/basket/?command=select_prdcnt&product_no=' + iProductNo + '&option_type=' + (window['option_type'] || '') + sOptionParam + sAddParam;
...
function create_layer(layerId, sHtml, oTarget)
{
    ...
    try {
        $(".xans-product-basketadd").find("a[href='http://ecudemo31431.cafe24.com/order/basket.html']").attr("href", "http://ecudemo31431.cafe24.com/order/basket.html?delvtype=" + delvtype);
    } catch (e) {}
    try {
        $(".xans-order-layerbasket").find("a[href='http://ecudemo31431.cafe24.com/order/basket.html']").attr("href", "http://ecudemo31431.cafe24.com/order/basket.html?delvtype=" + delvtype);
    } catch (e) {}
}
...
function basket_result_action(sType, sGroup, aData, sBasketType)
{
    ...
    if (aData.result >= 0) {
        ...
        if (sType == 'naver_checkout') {
            var sUrl = 'http://ecudemo31431.cafe24.com/exec/front/order/navercheckout';
        ...
        if (sType == 1) { // 바로구매하기
            if (aData.isLogin == 'T') { // 회원
                if (bOpener === true) {
                    ...
                    self.location.href = "http://ecudemo31431.cafe24.com/order/orderform.html?basket_type=" + sBasketType + "&delvtype=" + sDelvType;
                } else {
                    oTarget.location.href = "http://ecudemo31431.cafe24.com/order/orderform.html?basket_type=" + sBasketType + "&delvtype=" + sDelvType;
                }
            } else { // 비회원
                sUrl = '/member/login.html?noMember=1&returnUrl=' + encodeURIComponent('http://ecudemo31431.cafe24.com/order/orderform.html?basket_type=' + sBasketType + "&delvtype=" + sDelvType);
            ...
            if (sGroup == 'detail') {
                ...
                if (oCheckZoomPopUp.isPopUp() === true || bIsProgressLink === true) {
                    oTarget.location.href = "http://ecudemo31431.cafe24.com/order/basket.html?"  + "&delvtype=" + sDelvType;
                }
            } else {
        ...
        if (aData.result == -111 && sProductLink !== null) {
            oTarget.href = 'http://ecudemo31431.cafe24.com/product/detail.html?' + sProductLink;
        }
        if (aData.result == -101 || aData.result == -103) {
            sUrl = 'http://ecudemo31431.cafe24.com/member/login.html?noMember=1&returnUrl=' + encodeURIComponent(oTarget.location.href);
            oTarget.location.href = sUrl;
        }
    }
...
function layer_basket(sDelvType, oTarget)
{
    ...
    $('.xans-product-basketoption').remove();
    $.get('http://ecudemo31431.cafe24.com/product/add_basket.html?delvtype='+sDelvType, oProductName, function(sHtml)
        {
...
function layer_basket2(sDelvType, oTarget)
{
    ...
    var oTarget = CAPP_SHOP_FRONT_COMMON_UTIL.findTargetFrame();
    $.get('http://ecudemo31431.cafe24.com/product/add_basket2.html?delvtype=' + sDelvType + '&layerbasket=T', '', function(sHtml)
    {
        sHtml = sHtml.replace(/<script.*?ind-script\/optimizer.php.*?<\/script>/g, '');
...
{
    $('.layerWish').remove();
    $.get('http://ecudemo31431.cafe24.com/product/layer_wish.html','' ,function(sHtml)
    {
        sHtml = sHtml.replace(/<script.*?ind-script\/optimizer.php.*?<\/script>/g, '');
        create_layer('confirmLayer', sHtml, oTarget);
    });
...
{
    var oTarget = CAPP_SHOP_FRONT_COMMON_UTIL.findTargetFrame();
    oTarget.location.href = 'http://ecudemo31431.cafe24.com/order/basket.html';
    if (CAPP_SHOP_FRONT_COMMON_UTIL.isPopupFromThisShopFront() === true) {
        self.close();
    }
}
...
function move_basket_page()
{
    ...
    sLocation.href = 'http://ecudemo31431.cafe24.com/order/basket.html';
}
...
function go_detail()
{
    var sUrl = 'http://ecudemo31431.cafe24.com/product/detail.html?product_no=' + iProductNo;
    var oTarget = CAPP_SHOP_FRONT_COMMON_UTIL.findTargetFrame();
...
function check_action_nologin()
{
    ...
    sUrl = 'http://ecudemo31431.cafe24.com/member/login.html?returnUrl=' + encodeURIComponent(oTarget.location.href);
    oTarget.location.href = sUrl;
}
...
function add_wishlist(sMode, bIsUseOptionSelect)
{
    ...
    sUrl += 'http://ecudemo31431.cafe24.com/exec/front/Product/Wishlist/';
...
{
    var sUrl = 'http://ecudemo31431.cafe24.com/exec/front/Product/Wishlist/';
...
function optionPreview(obj, sAction, sProductNo, closeType)
{
    ...
    var sUrl = 'http://ecudemo31431.cafe24.com/product/option_preview.html';
...
function nv_add_basket_1_product()
{
    ...
    product_submit('naver_checkout', 'http://ecudemo31431.cafe24.com/exec/front/order/basket/')
}
...
function nv_add_basket_2_product()
{
    ...
    window.open("http://ecudemo31431.cafe24.com/exec/front/order/navercheckoutwish?product_no=" + iProductNo, "navercheckout_basket",
...
function nv_add_basket_2_m_product()
{
    ...
    window.location.href = "http://ecudemo31431.cafe24.com/exec/front/order/navercheckoutwish?product_no=" + iProductNo;
...
function action_email_restock(iProductNo)
{
    ...
    $('#frm_image_zoom').attr('action', 'http://ecudemo31431.cafe24.com/product/email_restock.html?product_no' + iProductNo);
    $('#frm_image_zoom').submit();
}
...
function popupDcCoupon(product_no, coupon_no, cate_no, opener_url, location)
{
    ...
    Url += 'http://ecudemo31431.cafe24.com/coupon_popup.html';
...
if (typeof(layer_basket_paging) !== 'function') {
  ...
  function layer_basket_paging(page_no)
  {
      ...
      $.get(sUrl, '', function(sHtml)
      {
          ...
          // set delvtype to basket
          try {
              $(".xans-order-layerbasket").find("a[href='/order/basket.html']").attr("href", "http://ecudemo31431.cafe24.com/order/basket.html?delvtype=" + delvtype);
          } catch (e) {}
      });
  }
}
...
if (typeof(Basket) === 'undefined') {
  var Basket = {
      orderLayerAll : function(oElem) {
          ...
          var sOrderUrl = $(oElem).attr('link-order') || 'http://ecudemo31431.cafe24.com/order/orderform.html?basket_type='+ aParam.basket_type;

          if (sBasketDelvType != "") {
              sOrderUrl += '&delvtype=' + sBasketDelvType;
          }
          var sLoginUrl = $(oElem).attr('link-login') || 'http://ecudemo31431.cafe24.com/member/login.html';
...
var EC_SHOP_FRONT_BASKET_VALIID = {
    ...
    isBasketProductDuplicateValid : function (sParam)
    {
        ...
        $.ajax({
            url:  'http://ecudemo31431.cafe24.com/exec/front/order/Basketduplicate/',
            type: 'post',
            data: sParam,
            async: false,
            dataType: 'json',
...
var STOCKLAYER = (function() {
    ...
    var sUrl = 'http://ecudemo31431.cafe24.com/product/stocklayer.html';
...
var EC_SHOP_FRONT_NEW_LIKE_COMMON = {
    ...
    getMyLikeCategoryNoInList: function(successCallbackFn, completeCallbackFn)
    {
        ...
        if (aData !== null) {
            ...
            $.ajax({
                url: 'http://ecudemo31431.cafe24.com/exec/front/shop/LikeCommon',
                type: 'get',
                data: {
...
var EC_SHOP_FRONT_REVIEW_TALK_REVIEW_COUNT = {
    ...
    setResponseCountData: function () {
        ...
        $.ajax({
            url: 'http://ecudemo31431.cafe24.com/exec/front/shop/ApiReviewtalkReviewcnt', type: 'get', data: {
...
{
    $.ajax({
        url : 'http://ecudemo31431.cafe24.com/exec/front/Myshop/ApiShoppinginfo',
        type : 'POST',
        cache : false,
        dataType: 'json',
        success : function(data){
...
var POPUP = {
    ...
    setPopupList : function ()
    {
        ...
        $.ajax({
            url: 'http://ecudemo31431.cafe24.com/exec/front/popup/AjaxMain',
            type: "post",
...
$(document).ready(function(){
    ...
    if (EC_FRONT_JS_CONFIG_MANAGE.sWebLogEventFlag == "F")
    {
        ...
        var _sUrlFull = 'http://ecudemo31431.cafe24.com/exec/front/eclog/main/?' + _sUrlQs;
...
var CAPP_ASYNC_METHODS = {
    ...
    init : function()
    {
        ...
        if (aNoCachedModules.length > 0) {
            ...
            $.ajax(
            {
                url : 'http://ecudemo31431.cafe24.com/exec/front/manage/async?module=' + aNoCachedModules.join(',') + sEditor + sPathRole,
                dataType : 'json',
