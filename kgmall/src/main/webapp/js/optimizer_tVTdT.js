...
var BOARD = {
    ...
    refresh_captcha : function(sType, iNo)
    {
        ...
        $('#'+sCaptchaId).attr('src', 'http://ecudemo31431.cafe24.com/exec/front/board/captcha?no='+iNo+'&type='+sType+'&'+new Date().getTime());
    },
...
var CAPP_SHOP_NEW_PRODUCT_OPTIONSELECT = {
    ...
    createLayer : function()
    {
        ...
        var url = 'http://ecudemo31431.cafe24.com/product/basket_option.html?product_no=' + this.iProductNo + '&sActionType=' + this.sActionType + '&cate_no=' + this.iCategoryNo;
